"""support_phase2_phase3

Revision ID: e83ee220eb9d
Revises: 780c7995be79
Create Date: 2026-03-13 07:15:36.809920
...
revision: str = 'e83ee220eb9d'
down_revision: Union[str, None] = '780c7995be79'
...
def upgrade() -> None:
    ...
    # Pre-fill NULLs before setting NOT NULL constraints
    ...
    op.execute("UPDATE licenses SET features = '[]' WHERE features IS NULL")
    ...
    op.execute("UPDATE project_recurring_configs SET template_task = '{}' WHERE template_task IS NULL")
    ...
    op.execute("UPDATE calendar_events SET priority = 'normal' WHERE priority IS NULL")
    ...
    op.alter_column('crm_knowledge_base_articles', 'not_helpful_count',
               ...
               existing_server_default=sa.text('0'),
               existing_nullable=True)
    op.execute("ALTER TABLE crm_knowledge_base_articles ALTER COLUMN embedding TYPE vector(1536) USING embedding::text::vector(1536)")
