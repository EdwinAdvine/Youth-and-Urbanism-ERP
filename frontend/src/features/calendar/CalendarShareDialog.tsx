          ...
          <div>
            ...
            <div className="flex gap-2">
              ...
              <select
                ...
                className="px-2 py-2 text-xs border border-gray-200 dark:border-gray-700 rounded-[8px] focus:outline-none"
              >
                ...
                {shares.map((share) => (
                  ...
                  >
                    ...
                    <select
                      ...
                      className="text-[10px] border border-gray-200 dark:border-gray-700 rounded-[4px] px-1 py-0.5 focus:outline-none"
                    >
                      <option value="view">View</option>
                      <option value="edit">Edit</option>
                      <option value="manage">Manage</option>
