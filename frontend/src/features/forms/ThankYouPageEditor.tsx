  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-sm font-semibold text-gray-900">Thank You Page</h3>
      ...
      {showPreview ? (
        /* Preview mode */
        <div className="bg-gray-50 rounded-[10px] border border-gray-200 p-8">
          <div className="flex flex-col items-center justify-center text-center max-w-md mx-auto">
            ...
            <h2 className="text-xl font-bold text-gray-900">{cfg.heading || 'Response Submitted'}</h2>
        ...
        /* Edit mode */
        <div className="space-y-3 bg-gray-50 rounded-[10px] border border-gray-200 p-4">
          <div>
            ...
            {cfg.redirectUrl && (
              <div className="mt-2">
                ...
                <input
                  ...
                  min={0}
                  max={30}
                  className="w-24 px-3 py-2 text-sm border border-gray-200 rounded-[8px] focus:outline-none focus:border-[#51459d]"
                />
              </div>
            )}
          </div>
