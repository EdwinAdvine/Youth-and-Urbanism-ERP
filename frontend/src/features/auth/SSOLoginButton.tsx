interface SSOLoginButtonProps {
  providerId: string
  providerName: string
  providerType: 'google' | 'microsoft' | 'github' | 'custom_oidc'
}
...
export default function SSOLoginButton({ providerId, providerName, providerType }: SSOLoginButtonProps) {
  const handleClick = () => {
    // Redirect to the SSO authorization endpoint
    window.location.href = `/api/v1/sso/${providerId}/authorize`
  }
