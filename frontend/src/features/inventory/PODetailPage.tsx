      ...
      <Card className="mb-6 hidden md:block">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-6">
          <div>
            ...
            <p className="text-sm font-semibold text-gray-900 mt-1">{po.supplier_name}</p>
          ...
          <div>
            ...
            <p className="text-sm text-gray-900 mt-1">{formatDate(po.order_date)}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-lg font-bold text-gray-900 mt-1">{formatCurrency(po.total)}</p>
          </div>
        </div>
        {po.notes && (
          ...
          <table className="w-full text-sm">
                ...
                po.lines.map((line: PurchaseOrderLine) => (
                  <tr key={line.id} className="border-b border-gray-50 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-right">
                      <span className={line.received_quantity >= line.quantity ? 'text-green-600 font-medium' : 'text-gray-700'}>
            ...
            <tfoot>
              <tr className="border-t border-gray-200 bg-gray-50">
                <td colSpan={4} className="py-3 px-4 text-right text-sm font-bold text-gray-900">Total</td>
