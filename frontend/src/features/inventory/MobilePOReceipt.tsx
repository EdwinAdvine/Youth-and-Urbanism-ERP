      ...
      <Card>
        ...
        <div className="grid grid-cols-2 gap-3 mt-3 text-sm">
          ...
          <div>
            ...
            <span className="font-semibold text-gray-900">{po.lines.length}</span>
          </div>
        </div>
      </Card>
            ...
            <Card key={line.id} className={isFullyReceived ? 'opacity-60' : ''}>
              ...
              <div className="grid grid-cols-3 gap-2 text-center mb-3">
                <div className="bg-gray-50 rounded-lg py-1.5">
                  <p className="text-lg font-bold text-gray-900">{line.quantity}</p>
              ...
              {isSent && !isFullyReceived && (
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="w-11 h-11 rounded-[10px] bg-gray-100 text-gray-700 font-bold text-lg flex items-center justify-center active:bg-gray-200"
