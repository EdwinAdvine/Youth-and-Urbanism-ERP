...
function ServerTab() {
  ...
  return (
    <Card>
      <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-5">Jitsi Server Configuration</h2>
...
function DefaultsTab() {
  ...
  return (
    <Card>
      <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-5">Meeting Default Settings</h2>
      <div className="space-y-4 max-w-lg">
        <NumberField label="Max Participants" value={form.max_participants} onChange={v => setForm({ ...form, max_participants: v })} />
        <div className="space-y-1">
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Default Video Quality</label>
...
function RecordingTab() {
  ...
  return (
    <Card>
      <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-5">Recording Configuration</h2>
      <div className="space-y-4 max-w-lg">
        ...
        <div className="space-y-1">
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Recording Format</label>
...
function ThemeTab() {
  ...
  return (
    <Card>
      <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-5">Jitsi UI Theme</h2>
      <div className="space-y-5 max-w-2xl">
        ...
        <div className="space-y-2">
          <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Toolbar Buttons</label>
                ...
                <button
                  ...
                  className={`px-2.5 py-1 text-xs rounded-full border transition-colors ${
                    active
                      ...
                      : 'bg-gray-50 dark:bg-gray-950 border-gray-200 dark:border-gray-700 text-gray-400 hover:border-gray-300 dark:hover:border-gray-600'
                  }`}
                >
                  {btn}
                </button>
        ...
        {/* Preview */}
        <div className="rounded-[10px] border border-gray-100 dark:border-gray-800 p-4 bg-gray-50 dark:bg-gray-950">
...
function SIPTab() {
  ...
  return (
    <Card>
      <h2 className="text-base font-semibold text-gray-900 dark:text-gray-100 mb-5">SIP Gateway Configuration</h2>
...
export default function MeetingsConfigPage() {
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      <div className="mb-6">
        <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100">Meetings Administration</h1>
