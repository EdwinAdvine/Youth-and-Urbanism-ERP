  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Meeting Templates</h1>
          <p className="text-sm text-gray-500 mt-1">Create reusable meeting setups</p>
        </div>
        <Button onClick={() => setShowModal(true)} className="w-full sm:w-auto">New Template</Button>
      </div>
