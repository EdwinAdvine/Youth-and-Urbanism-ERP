...
export default function TableOfContents({ content, onClose }: TableOfContentsProps) {
  ...
  return (
    <div className="w-56 border-l border-gray-100 bg-white flex flex-col h-full">
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-3 border-b border-gray-100 shrink-0">
        <h3 className="text-xs font-semibold text-gray-900">Table of Contents</h3>
          ...
          <nav className="space-y-0.5 px-2">
            {entries.map((entry, idx) => (
              <button
                ...
                className="w-full text-left py-1.5 rounded-[6px] hover:bg-gray-50 transition-colors group"
              ...
              >
                <div className="flex items-center gap-1.5">
                  ...
                  />
                  <span
                    className={`truncate group-hover:text-[#51459d] transition-colors ${
                      entry.level === 1
